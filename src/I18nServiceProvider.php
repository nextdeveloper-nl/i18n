 ...
 */
class I18nServiceProvider extends AbstractServiceProvider {
    /**
     * @var bool
     */
    ...
    public function boot() {
        ...
        $this->loadViewsFrom($this->dir.'/../resources/views', 'I18n');
...
//    }
    ...
    protected function registerRoutes() {
        if ( ! $this->app->routesAreCached()) {
            $this->app['router']
                ->namespace('NextDeveloper\I18n\Http\Controllers')
